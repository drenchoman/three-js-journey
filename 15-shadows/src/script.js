...
const direcetionalLightCameraHelper = new THREE.CameraHelper(
  directionalLight.shadow.camera
);
direcetionalLightCameraHelper.visible = false;
scene.add(direcetionalLightCameraHelper);
